...
def module_teardown(device_host, data_dir, platform_data_dir, app_dir, service_prefix):
    ...
    run_ssh(device_host, 'systemctl status {0}syncthing.syncthing > {1}/syncthing.php-fpm.status.log'.format(service_prefix, TMP_DIR), password=LOGS_SSH_PASSWORD, throw=False)
