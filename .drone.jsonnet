...
local build(arch, test_ui) = [{
  ...
  steps: [
  ...
  ] + [
    {
      name: 'syncthing',
      image: 'debian:' + debian,
      commands: ['./syncthing/build.sh ' + version + ' ' + arch],
    },
  ] + [
    {
      name: 'syncthing test ' + distro,
      image: platform_image(distro),
      commands: ['./syncthing/test.sh'],
    }
    for distro in distros
  ] + [
    {
  ...
  ] + [
    {
      name: 'test ' + distro,
      image: 'python:' + python,
      commands: ['./ci/test.sh test.py ' + distro + ' ' + name + ' ' + arch],
    }
    for distro in distros
  ] + (if test_ui then [
         {
         ...
         },
         {
           ...
           image: 'python:' + python,
           commands: ['./ci/test.sh upgrade_prev.py ' + distro_default + ' ' + name + ' ' + arch],
         },
         {
         ...
         },
         {
           name: 'test-upgrade',
           image: 'python:' + python,
           commands: ['./ci/test.sh upgrade.py ' + distro_default + ' ' + name + ' ' + arch],
         },
         {
